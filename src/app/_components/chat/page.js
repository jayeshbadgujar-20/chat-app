            ...
            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-2xl border border-cyan-500/20 mb-3">
              ...
              <div className="flex items-center gap-2 ml-4">
                ...
                <button
                  ...
                  className={`w-14 h-14 rounded-full flex items-center justify-center transition-all shadow-xl hover:scale-105 ${
                    isPlaying ? "bg-white text-slate-900 shadow-white/30" : "bg-gradient-to-r from-cyan-400 to-blue-500 text-white shadow-cyan-500/40"
                  }`}
                >
                  {isPlaying ? (
          ...
          <div className="flex-1 overflow-y-auto flex flex-col gap-2 py-2 px-1 custom-scrollbar" ref={scroll}>
            ...
            {chat.map((msg, index) => (
              ...
              >
                ...
                <div className={`py-2.5 px-4 max-w-[70%] rounded-2xl ${
                  msg.senderId === userId
          ...
          <div className="flex items-center gap-2 mt-2">
            <button
              ...
              className={`flex-shrink-0 w-12 h-12 rounded-xl border flex items-center justify-center transition-all ${
                showEmoji ? 'bg-cyan-500/20 border-cyan-500/40' : 'bg-slate-800/80 hover:bg-slate-700/80 border-slate-600/50'
              }`}
            >
            ...
            <button
              onClick={() => setModal(true)}
              className="flex-shrink-0 w-12 h-12 rounded-xl bg-slate-800/80 hover:bg-slate-700/80 border border-cyan-500/20 flex items-center justify-center transition-all hover:scale-105"
            >
              <span className="text-xl">🎵</span>
            </button>
            <button
